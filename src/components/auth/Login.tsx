        ...
        <Box className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          >
            ...
            <Box className="flex gap-8 mt-12">
              ...
              <Box>
                <Typography variant="h3" className="font-bold mb-1">50+</Typography>
                <Typography className="opacity-80">Languages</Typography>
              </Box>
              <Box>
                <Typography variant="h3" className="font-bold mb-1">1M+</Typography>
                <Typography className="opacity-80">Users</Typography>
              </Box>
            </Box>
          </motion.div>
        </Box>
              ...
              <Box className="space-y-5 ">
                ...
                <Box className="text-center pt-4">
                  <Typography variant="body2" className="text-gray-600">
                    ...
                    <span className="text-violet-600 cursor-pointer hover:text-violet-700 font-semibold">
                      Create account
                    </span>
                  </Typography>
                </Box>
